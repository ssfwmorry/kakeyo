...
// typeId ごとに畳み込んで TypeSummaryItem（subTypes 配列）へ整形する。
...
// - subTypes は subTypeId/subTypeName/subTypeSum が揃い、かつ subTypeSum!==0 の行のみ nest する（0 は落とす）。
// 入力は order by sum desc 順で来る前提。畳み込み後もその出現順を保つ。
