...
import { SectionListEmpty } from '@/v2/components/section-list';
import { ThemeToggle } from '@/v2/components/theme-toggle';
import { Segment, type SegmentOption } from '@/v2/components/ui/segment';
...
//
// 旧画面にあったカテゴリ／方法・立替込みの切替、サブカテゴリ行、明細への遷移は
// デザインに無いので出さない。立替の扱いは旧既定のまま（個人モードは立替込み、
// 共有モードは含めない）。
//
